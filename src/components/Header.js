...
export const Header = () => {
  ...
  return (
    <div id="home" className='h-85 bg-sky-blue flex flex-col items-center justify-center'>
      ...
      <div className='w-full h-full flex flex-col items-center justify-center pt-24 md:pt-64 lg:pt-28 xl:pt-36'>
        <img alt="" src={planeImg} className="w-80 md:w-1/2 lg:w-4/12 xl:w-3/12" />
