...
export const Header = () => {
  ...
  return (
    <div id="home" className='h-85 bg-sky-blue flex flex-col items-center justify-center'>
      ...
      <div className='w-full h-full flex flex-col items-center justify-center pt-15 lg:pt-28'>
        <img alt="" src={planeImg} className="w-11/12 lg:w-4/12" />
        <h1 className='pt-12 pb-12 lg:pt-7 lg:pb-8 w-2/3 text-white font-sacramento text-center text-8xl lg:text-9xl drop-shadow'>Cristina y Carlos</h1>
        <Countdown />
      </div>
