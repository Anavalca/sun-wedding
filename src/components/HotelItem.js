...
export const HotelItem = ({element}) => {
  ...
  return (
    <div className={`p-5 lg:p-6 m-2 w-auto lg:w-85 h-72 bg-yellow-opacity flex flex-col items-left justify-between font-light drop-shadow ${isFull ? 'border-b-8 border-red' : ''}`} data-aos="fade-up">
